...
public class Empleado {
    ...
    public Empleado(int codigoEmpleado, int numeroEmpleado, String apellidosEmpleado, String nombresEmpleado, 
            String direccionEmpleado, String telefonoContacto, String gradoCocinero, int codigoTipoEmpleado) {
    ...
    public String toString(){
        return getCodigoTipoEmpleado ()+ " | " + getNombresEmpleado();
    }
}
